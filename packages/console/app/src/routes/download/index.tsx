...
import desktopAppIcon from "../../asset/lander/grexcode-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://grexlabs.in/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>grexlabs.in/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g grexcode-ai")}>
                <code>
                  npm i -g <strong>grexcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g grexcode-ai")}>
                <code>
                  bun add -g <strong>grexcode-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install grexlabs/tap/grexcode")}>
                <code>
                  brew install <strong>grexlabs/tap/grexcode</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S grexcode")}>
                <code>
                  paru -S <strong>grexcode</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask grexcode-desktop")}>
                <code>
                  brew install --cask <strong>grexcode-desktop</strong>
                </code>
                <CopyStatus />
              </button>
