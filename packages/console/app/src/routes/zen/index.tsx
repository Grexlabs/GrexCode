...
import compareVideo from "../../asset/lander/grexcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/grexcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="grexcode:auth" content={loggedin() ? "true" : "false"} />
