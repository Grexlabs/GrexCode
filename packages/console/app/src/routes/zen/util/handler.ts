...
import { and, Database, eq, isNull, lt, or, sql } from "@grexlabs/console-core/drizzle/index.js"
import { KeyTable } from "@grexlabs/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@grexlabs/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@grexlabs/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@grexlabs/console-core/util/date.js"
import { Identifier } from "@grexlabs/console-core/identifier.js"
import { Billing } from "@grexlabs/console-core/billing.js"
import { Actor } from "@grexlabs/console-core/actor.js"
...
import { Subscription } from "@grexlabs/console-core/subscription.js"
import { BlackData } from "@grexlabs/console-core/black.js"
import { UserTable } from "@grexlabs/console-core/schema/user.sql.js"
import { ModelTable } from "@grexlabs/console-core/schema/model.sql.js"
import { ProviderTable } from "@grexlabs/console-core/schema/provider.sql.js"
...
import { LiteData } from "@grexlabs/console-core/lite.js"
import { Resource } from "@grexlabs/console-resource"
...
export async function handler(
  ...
  const ADMIN_WORKSPACES = [
    "wrk_01K46JDFR0E75SG2Q8K172KF3Y", // grexlabs
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-grexcode-session") ?? ""
    const requestId = input.request.headers.get("x-grexcode-request") ?? ""
    const ocClient = input.request.headers.get("x-grexcode-client") ?? ""
    const projectId = input.request.headers.get("x-grexcode-project") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-grexcode-request")
          headers.delete("x-grexcode-session")
          headers.delete("x-grexcode-project")
          headers.delete("x-grexcode-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://grexlabs.in/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://grexlabs.in/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://grexlabs.in/workspace/${authInfo.workspaceID}/members`
