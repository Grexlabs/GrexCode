...
export const TypeId: TypeId = "~@grexlabs/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@grexlabs/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@grexlabs/effect-sqlite-node/NodeSqliteClient")
