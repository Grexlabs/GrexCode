...
beforeAll(async () => {
  ...
  mock.module("@grexlabs/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@grexlabs/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@grexlabs/ui/icon", () => ({ Icon: () => null }))
  mock.module("@grexlabs/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
