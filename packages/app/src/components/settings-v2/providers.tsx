import { ButtonV2 } from "@grexlabs/ui/v2/button-v2"
import { Tag } from "@grexlabs/ui/v2/badge-v2"
...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "grexcode", key: "dialog.provider.grexcode.note" },
  { match: (id: string) => id === "grexcode-go", key: "dialog.provider.grexcodeGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "grexcode" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "grexcode" || item.id === "grexcode-go"}>
