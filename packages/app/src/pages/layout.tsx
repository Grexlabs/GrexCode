...
import { ResizeHandle } from "@grexlabs/ui/resize-handle"
import { Button } from "@grexlabs/ui/button"
import { IconButton } from "@grexlabs/ui/icon-button"
import { Tooltip } from "@grexlabs/ui/tooltip"
...
import { Session, type Message } from "@grexlabs/sdk/v2/client"
...
import { toaster } from "@grexlabs/ui/toast"
...
import { useTheme, type ColorScheme } from "@grexlabs/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://grexlabs.in/desktop-feedback")}
      renderPanel={() =>
