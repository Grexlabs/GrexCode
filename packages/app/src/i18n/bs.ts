export const dict = {
  ...
  "dialog.provider.grexcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.grexcode.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.grexcodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje GrexCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u GrexCode-u.",
  ...
  "provider.connect.grexcodeZen.line1":
    "GrexCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.grexcodeZen.visit.prefix": "Posjeti ",
  "provider.connect.grexcodeZen.visit.link": "grexlabs.in/zen",
  "provider.connect.grexcodeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u GrexCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u GrexCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u grexcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se GrexCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija GrexCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku GrexCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (grexcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: GrexCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "GrexCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni GrexCode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u GrexCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako GrexCode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li GrexCode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu GrexCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se GrexCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju GrexCode-a.",
