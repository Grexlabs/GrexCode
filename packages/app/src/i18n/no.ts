...
export const dict = {
  ...
  "dialog.provider.grexcode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.grexcode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.grexcodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av GrexCode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i GrexCode.",
  ...
  "provider.connect.grexcodeZen.line1":
    "GrexCode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.grexcodeZen.visit.prefix": "Besøk ",
  "provider.connect.grexcodeZen.visit.link": "grexlabs.in/zen",
  "provider.connect.grexcodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i GrexCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i GrexCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i grexcode.json",
  ...
  "dialog.server.description": "Bytt hvilken GrexCode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av GrexCode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til GrexCode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (grexcode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at GrexCode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "GrexCode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør GrexCode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for GrexCode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan GrexCode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om GrexCode skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan GrexCode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når GrexCode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av GrexCode.",
