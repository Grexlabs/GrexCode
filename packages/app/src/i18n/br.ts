export const dict = {
  ...
  "dialog.provider.grexcode.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.grexcode.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.grexcodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo GrexCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no GrexCode.",
  ...
  "provider.connect.grexcodeZen.line1":
    "GrexCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.grexcodeZen.visit.prefix": "Visite ",
  "provider.connect.grexcodeZen.visit.link": "grexlabs.in/zen",
  "provider.connect.grexcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no GrexCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no GrexCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em grexcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor GrexCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do GrexCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do GrexCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (grexcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: GrexCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "GrexCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor GrexCode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do GrexCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o GrexCode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o GrexCode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o GrexCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o GrexCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do GrexCode.",
