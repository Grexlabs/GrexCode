export const dict = {
  ...
  "dialog.provider.grexcode.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.grexcode.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.grexcodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez GrexCode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w GrexCode.",
  ...
  "provider.connect.grexcodeZen.line1":
    "GrexCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.grexcodeZen.visit.prefix": "Odwiedź ",
  "provider.connect.grexcodeZen.visit.link": "grexlabs.in/zen",
  "provider.connect.grexcodeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w GrexCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w GrexCode.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w grexcode.json",
  ...
  "dialog.server.description": "Przełącz serwer GrexCode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja GrexCode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu GrexCode",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (grexcode.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "GrexCode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla GrexCode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd GrexCode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy GrexCode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw GrexCode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania GrexCode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji GrexCode.",
