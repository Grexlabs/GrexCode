export const dict = {
  ...
  "dialog.provider.grexcode.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.grexcode.tagline": "Reliable optimized models",
  "dialog.provider.grexcodeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by GrexCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in GrexCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.grexcodeZen.line1":
    "GrexCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.grexcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.grexcodeZen.visit.prefix": "Visit ",
  "provider.connect.grexcodeZen.visit.link": "grexlabs.in/zen",
  "provider.connect.grexcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in GrexCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in GrexCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in grexcode.json",
  ...
  "dialog.server.description": "Switch which GrexCode server this app connects to.",
  ...
  "wsl.onboarding.step.grexcode": "GrexCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking GrexCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking GrexCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating GrexCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating GrexCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update GrexCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update GrexCode",
  "wsl.onboarding.grexcodeReadyIn": "GrexCode is ready in {{distro}}.",
  "wsl.onboarding.grexcodeReady": "GrexCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install GrexCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install GrexCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen GrexCode.",
  ...
  "toast.update.description": "A new version of GrexCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the GrexCode team",
  ...
  "error.chain.checkConfig": "Check your config (grexcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, GrexCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "GrexCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "GrexCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the GrexCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for GrexCode",
  ...
  "settings.general.row.appearance.description": "Customise how GrexCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether GrexCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how GrexCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when GrexCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of GrexCode.",
