...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "GrexCode Documentation", href: "https://grexlabs.in/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/grexcode" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/grexlabs/grexcode/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/grexlabs/grexcode/issues/new?template=bug_report.yml",
      },
    ],
  },
]
