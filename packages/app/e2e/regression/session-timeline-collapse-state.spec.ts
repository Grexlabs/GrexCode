...
import { mockGrexCodeServer } from "../utils/mock-server"
import { expectAppVisible, expectSessionTitle } from "../utils/waits"

const directory = "C:/GrexCode/TimelineStateRegression"
...
const model = { providerID: "grexcode", modelID: "claude-opus-4-6", variant: "max" }
...
function provider() {
  return {
    ...
    connected: ["grexcode"],
    default: { providerID: "grexcode", modelID: "claude-opus-4-6" },
  }
}
