...
export function registerWslIpcHandlers(controller: WslServersController) {
  ...
  ipcMain.handle("wsl-servers-probe-grexcode", (_event: IpcMainInvokeEvent, name: string) =>
    controller.probeOpencode(requireWslIpcString("distro", name)),
  )
  ipcMain.handle("wsl-servers-install-grexcode", (_event: IpcMainInvokeEvent, name: string) =>
...
function registerUnavailableWslIpcHandlers() {
  ...
  ipcMain.handle("wsl-servers-probe-grexcode", unavailable)
  ipcMain.handle("wsl-servers-install-grexcode", unavailable)
