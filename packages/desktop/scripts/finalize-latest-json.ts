...
const releaseId = process.env.GREXCODE_RELEASE
if (!releaseId) throw new Error("GREXCODE_RELEASE is required")

const version = process.env.GREXCODE_VERSION
if (!version) throw new Error("GREXCODE_VERSION is required")
...
const macxTarGz = "grexcode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "grexcode-desktop-mac-arm64.app.tar.gz"
