...
class Database extends Context.Service<Database, DatabaseShape>()("@grexcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@grexcode/example/UserStore") {
