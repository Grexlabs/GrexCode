...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/grexcode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/grexcode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/grexcode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/grexcode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const GREXCODE_DB|GREXCODE_DB|GREXCODE_DEV|Global\\.Path\\.data|data =" in packages/grexcode/src (115 matches)',
  },
] as const
