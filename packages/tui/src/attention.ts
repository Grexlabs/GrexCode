...
import defaultSoundPath from "@grexlabs/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@grexlabs/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@grexlabs/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@grexlabs/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@grexlabs/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@grexlabs/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "grexcode"
const DEFAULT_PACK_ID = "grexcode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "GrexCode Default",
  builtin: true,
  sounds: {
