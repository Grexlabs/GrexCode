import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@grexlabs/sdk/v2"
import { SessionTurn } from "@grexlabs/ui/session-turn"
import { SessionReview } from "@grexlabs/ui/session-review"
import { DataProvider } from "@grexlabs/ui/context"
import { FileComponentProvider } from "@grexlabs/ui/context/file"
import { WorkerPoolProvider } from "@grexlabs/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@grexlabs/ui/logo"
import { IconButton } from "@grexlabs/ui/icon-button"
import { ProviderIcon } from "@grexlabs/ui/provider-icon"
import { iife } from "@grexlabs/core/util/iife"
import { Binary } from "@grexlabs/core/util/binary"
import { NamedError } from "@grexlabs/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@grexlabs/ui/tabs"
import { MessageNav } from "@grexlabs/ui/message-nav"
import { FileSSR } from "@grexlabs/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@grexlabs/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/grexcode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | GrexCode</Title>
              </Show>
              <Meta name="description" content="grexcode - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/grexlabs/grexcode"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://grexlabs.in/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
