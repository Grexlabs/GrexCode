...
import { IconGrexcode } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "grexcode/session/message-v2"
import type { Message } from "grexcode/session/message"
import type { Session } from "grexcode/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.grexcode_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.grexcode_name}>
                    <IconGrexcode width={16} height={16} />
                  </div>
