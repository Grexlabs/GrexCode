...
- Global: `~/.config/grexcode/agents/`
- Per-project: `.grexcode/agents/`

```markdown title="~/.config/grexcode/agents/review.md"
---
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/Grexlabs/GrexCode).
:::
...
```markdown title="~/.config/grexcode/agents/docs-writer.md"
---
...
```markdown title="~/.config/grexcode/agents/security-auditor.md"
---
