...
import type { EffectDrizzleSqlite } from "@grexlabs/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/ProjectDirectories") {}
