...
declare const GREXCODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof GREXCODE_LIBC === "undefined" ? undefined : GREXCODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.GREXCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.GREXCODE_EXPERIMENTAL_FILEWATCHER) {
