...
export class Service extends Context.Service<Service, Interface>()("@grexcode/v2/FileSystem/Search") {}
...
export const locationLayer = Layer.unwrap(
  Effect.sync(() => (Flag.GREXCODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
