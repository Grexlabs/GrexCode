...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@grexlabs/llm"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/v2/ToolRegistry") {}
