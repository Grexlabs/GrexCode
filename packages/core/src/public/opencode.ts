export * as GrexCode from "./grexcode"
...
/** Intentional public native API for Effect applications embedding GrexCode. */
export class Service extends Context.Service<Service, Interface>()("@grexcode/public/GrexCode") {}
...
// TODO: Add GrexCode.create(...) as the Promise facade over the same native API semantics.
