...
- Effect plugins import `@grexlabs/plugin/v2/effect`, not `@grexlabs/core`.
- Public domain values use generated `@grexlabs/sdk` types.
...
- Define `PluginHost` domain capabilities in `@grexlabs/plugin/v2/effect`.
