import grexcodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/grexlabs/grexcode",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star GrexCode on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "grexcode:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://grexlabs.in/">
            <strong>Try GrexCode</strong>
          </a>
          <button
...
function GrexCodeMark() {
  return (
    <svg data-slot="grexcode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://grexlabs.in/legal/terms-of-service", label: "Terms of service" },
    { href: "https://grexlabs.in/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@grexlabs.in", label: "Contact us" },
    { href: "https://grexlabs.in/discord", label: "Community" },
    { href: "https://x.com/grexcode", label: "X" },
    githubLink,
    { href: "https://www.youtube.com/@grexlabs-co", label: "YouTube" },
  ]
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://grexlabs.in" aria-label="GrexCode home">
          <GrexCodeMark />
        </a>
      ...
      <div data-slot="footer-bottom">
        <div>
          <span>© 2026 Grexlabs Innovations Inc.</span>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={grexcodeWordmarkDark} alt="GrexCode" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">GrexCode Newsletter</h2>
            <p>
