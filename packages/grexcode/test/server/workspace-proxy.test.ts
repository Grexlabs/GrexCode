...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips grexcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-grexcode-directory"]).toBeUndefined()
      expect(forwarded["x-grexcode-workspace"]).toBeUndefined()
