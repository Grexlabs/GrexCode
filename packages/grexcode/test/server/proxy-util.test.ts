...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips grexcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-grexcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-grexcode-directory")).toBeNull()
      expect(result.get("x-grexcode-workspace")).toBeNull()
