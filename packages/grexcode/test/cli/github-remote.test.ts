...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/grexcode.git")).toEqual({ owner: "sst", repo: "grexcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/grexcode")).toEqual({ owner: "sst", repo: "grexcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/grexcode.git")).toEqual({ owner: "sst", repo: "grexcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/grexcode")).toEqual({ owner: "sst", repo: "grexcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/grexcode.git")).toEqual({ owner: "sst", repo: "grexcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/grexcode")).toEqual({ owner: "sst", repo: "grexcode" })
})
