...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders GREXCODE_CALLER", () => {
    process.env["GREXCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode GREXCODE_CALLER", () => {
    process.env["GREXCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown GREXCODE_CALLER", () => {
    process.env["GREXCODE_CALLER"] = "unknown"
