...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __GREXCODE_PHOTON_WASM_PATH?: string }).__GREXCODE_PHOTON_WASM_PATH =
