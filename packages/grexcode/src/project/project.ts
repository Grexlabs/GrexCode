...
import { ProjectDirectoryTable, ProjectTable } from "@grexlabs/core/project/sql"
...
import { which } from "@grexlabs/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@grexlabs/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.GREXCODE_FAKE_VCS)
