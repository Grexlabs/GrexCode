...
import { AccountStateTable, AccountTable } from "@grexlabs/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/AccountRepo") {}
