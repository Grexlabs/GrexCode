...
export const RootHttpApi = HttpApi.make("grexcode-root")
...
export const InstanceHttpApi = HttpApi.make("grexcode-instance")
...
export const GrexCodeHttpApi = HttpApi.make("grexcode")
