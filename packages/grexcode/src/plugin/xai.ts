...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=grexcode` lets xAI attribute grexcode-originated
...
<html>
  <head>
    <title>GrexCode - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>GrexCode - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire grexcode process. Matches the silent-
