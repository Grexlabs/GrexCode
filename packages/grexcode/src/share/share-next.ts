...
import type * as SDK from "@grexlabs/sdk/v2"
...
import { SessionShareTable } from "@grexlabs/core/share/sql"
...
const disabled = process.env["GREXCODE_DISABLE_SHARE"] === "true" || process.env["GREXCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/ShareNext") {}
