import type { JsonSchema, LLMRequest, ProviderMetadata } from "@grexlabs/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@grexlabs/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @grexlabs/llm request objects from grexcode's session/AI SDK-shaped data.
  return LLM.request({
