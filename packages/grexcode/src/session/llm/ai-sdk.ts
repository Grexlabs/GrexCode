import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@grexlabs/llm"
...
// Move this extraction into @grexlabs/llm when Copilot is handled by the native runtime.
