...
import { PermissionV1 } from "@grexlabs/core/v1/permission"
import { Slug } from "@grexlabs/core/util/slug"
import { SessionV1 } from "@grexlabs/core/v1/session"
import { serviceUse } from "@grexlabs/core/effect/service-use"
import path from "path"
import { BackgroundJob } from "@/background/job"
import { Decimal } from "decimal.js"
import type { ProviderMetadata, Usage } from "@grexlabs/llm"
...
import { PartTable, SessionTable } from "@grexlabs/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@grexlabs/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".grexcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Session") {}
