...
import type { AssistantMessage as GrexCodeAssistantMessage, Message } from "@grexlabs/sdk/v2"
...
export type AssistantTokenCost = Pick<GrexCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<GrexCodeAssistantMessage, "role"> &
  Partial<Pick<GrexCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@grexcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@grexcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@grexcode/ACPUsage") {}
