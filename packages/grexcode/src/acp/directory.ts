...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@grexcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@grexcode/ACPDirectory") {}
