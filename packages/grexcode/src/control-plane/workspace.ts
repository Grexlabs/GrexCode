...
import { EventSequenceTable, EventTable } from "@grexlabs/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        GREXCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        GREXCODE_WORKSPACE_ID: config.id,
        GREXCODE_EXPERIMENTAL_WORKSPACES: "true",
