...
import { path } from "@grexlabs/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@grexlabs/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `grexcode/${name}`
