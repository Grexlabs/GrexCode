...
//
// The saved variant persists across sessions in ~/.local/state/grexcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@grexcode/RunVariant") {}
