...
import type { Event, GlobalEvent, OpencodeClient } from "@grexlabs/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@grexcode/RunStreamTransport") {}
