...
import { normalizePromptContent } from "@grexlabs/tui/editor"
...
import { GREXCODE_BASE_MODE, useBindings } from "@grexlabs/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close GrexCode" } satisfies SlashOption,
    ]
