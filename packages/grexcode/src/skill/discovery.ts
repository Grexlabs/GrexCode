...
import { httpClient, path } from "@grexlabs/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/SkillDiscovery") {}
