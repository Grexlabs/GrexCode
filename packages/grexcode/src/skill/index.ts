...
import { FrontmatterError } from "@grexlabs/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@grexlabs/core/util/glob"
...
const GREXCODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with grexcode. The model's intuition for what an
// grexcode.json should look like is often wrong, and grexcode hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch grexcode's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_GREXCODE_SKILL_NAME = "customize-grexcode"
const CUSTOMIZE_GREXCODE_SKILL_DESCRIPTION =
...
const CUSTOMIZE_GREXCODE_SKILL_BODY = SkillPlugin.CustomizeOpencodeContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, GREXCODE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@grexcode/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_GREXCODE_SKILL_NAME] = {
          name: CUSTOMIZE_GREXCODE_SKILL_NAME,
          description: CUSTOMIZE_GREXCODE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_GREXCODE_SKILL_BODY,
        }
