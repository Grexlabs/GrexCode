 ...
 *   "@grexcode/ServerAuthConfig",
 *   {
 *     password: Config.string("GREXCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("GREXCODE_SERVER_USERNAME").pipe(Config.withDefault("grexcode")),
 *   },
 * ) {}
 *
