...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/grexcode`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy grexcode service removed
