...
Practical reference for the current tool-migration state in `packages/grexcode`.
...
Tool tests should use the existing Effect helpers in `packages/grexcode/test/lib/effect.ts`:
