...
# Package managers
npm i -g grexcode-ai@latest        # or bun/pnpm/yarn
scoop install grexcode             # Windows
choco install grexcode             # Windows
brew install grexlabs/tap/grexcode # macOS and Linux (recommended, always up to date)
brew install grexcode              # macOS and Linux (official brew formula, updated less)
sudo pacman -S grexcode            # Arch Linux (Stable)
paru -S grexcode-bin               # Arch Linux (Latest from AUR)
mise use -g grexcode               # Any OS
nix run nixpkgs#grexcode           # or github:grexlabs/grexcode for latest dev branch
```
...
GrexCode ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/grexlabs/grexcode/releases) অথবা [grexlabs.in/download](https://grexlabs.in/download) থেকে ডাউনলোড করুন।
...
4. `$HOME/.grexcode/bin` - ডিফল্ট ফলব্যাক
...
GrexCode এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://grexlabs.in/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে GrexCode কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://grexlabs.in/docs)।

### অবদান (Contributing)

আপনি যদি GrexCode এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### GrexCode এর উপর বিল্ডিং (Building on GrexCode)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা GrexCode এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "grexcode" ব্যবহার করেন, উদাহরণস্বরূপ "grexcode-dashboard" বা "grexcode-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি GrexCode দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/grexcode) | [X.com](https://x.com/grexcode)
