...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/grexlabs/grexcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for grexlabs/grexcode...\n")
...
console.log("Fetching npm all-time downloads for grexcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("grexcode-ai")
