...
Generates UPCOMING_CHANGELOG.md by running the grexcode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for grexcode run (default: low)
      --quiet            Suppress grexcode command output unless it fails
