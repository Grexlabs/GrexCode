...
- PR #10809: https://github.com/grexlabs/grexcode/pull/10809
- PR #11496: https://github.com/grexlabs/grexcode/pull/11496

## Do Not Translate (Locale Additions)

- `GrexCode` (preserve casing in prose; keep `grexcode` only in commands, package names, paths, or code)
- `GrexCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
