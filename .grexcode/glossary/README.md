...
Use this folder for locale-specific translation guidance that supplements `.grexcode/agent/translator.md`.
...
- PR #12345: https://github.com/grexlabs/grexcode/pull/12345

## Do Not Translate (Locale Additions)

- `GrexCode` (preserve casing)
