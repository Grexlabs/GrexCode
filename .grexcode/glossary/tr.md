...
- PR #15835: https://github.com/grexlabs/grexcode/pull/15835

## Do Not Translate (Locale Additions)

- `GrexCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `grexcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `GrexCode` in prose, `grexcode` only for exact technical identifiers
...
- Avoid changing `grexcode` to `GrexCode` inside commands, URLs, package names, or code literals
