...
- PR #13942: https://github.com/grexlabs/grexcode/pull/13942

## Do Not Translate (Locale Additions)

- `GrexCode` (preserve casing in prose; keep `grexcode` only when it is part of commands, package names, paths, or code)
- `GrexCode Zen`
- `GrexCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `grexcode` in prose when referring to the product name; use `GrexCode`
