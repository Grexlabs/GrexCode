...
Desktop application and browser-based app issues, including `grexcode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core grexcode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

GrexCode Zen, GrexCode Go, and billing issues.
