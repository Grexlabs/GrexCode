<p align="center">
  <a href="https://grexlabs.in">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار GrexCode">
    </picture>
  </a>
</p>
...
# مديري الحزم
npm i -g grexcode-ai@latest        # او bun/pnpm/yarn
scoop install grexcode             # Windows
choco install grexcode             # Windows
brew install grexlabs/tap/grexcode # macOS و Linux (موصى به، دائما محدث)
brew install grexcode              # macOS و Linux (صيغة brew الرسمية، تحديث اقل)
sudo pacman -S grexcode            # Arch Linux (Stable)
paru -S grexcode-bin               # Arch Linux (Latest from AUR)
mise use -g grexcode               # اي نظام
nix run nixpkgs#grexcode           # او github:grexlabs/grexcode لاحدث فرع dev
```
...
يتوفر GrexCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/grexlabs/grexcode/releases) او من [grexlabs.in/download](https://grexlabs.in/download).
...
4. `$HOME/.grexcode/bin` - المسار الافتراضي الاحتياطي
...
يتضمن GrexCode وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
تعرف على المزيد حول [agents](https://grexlabs.in/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط GrexCode، [**راجع التوثيق**](https://grexlabs.in/docs).

### المساهمة

اذا كنت مهتما بالمساهمة في GrexCode، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.

### البناء فوق GrexCode

اذا كنت تعمل على مشروع مرتبط بـ GrexCode ويستخدم "grexcode" كجزء من اسمه (مثل "grexcode-dashboard" او "grexcode-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق GrexCode ولا يرتبط بنا بأي شكل.

---

**انضم الى مجتمعنا** [Discord](https://discord.gg/grexcode) | [X.com](https://x.com/grexcode)
